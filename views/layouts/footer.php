 ...
 <footer class="bg-teal-700">
        <div class="footer-container grid grid-cols-3 py-9 ">
            ...
            <div class="navbar-links text-center text-white space-y-1">
                ...
                <h1 class="text-base hover:text-xl hover:font-semibold" >Home</h1>
                <h1 class="hover:text-xl hover:font-semibold">Blog</h1>
                <h1 class="hover:text-xl hover:font-semibold">Companies</h1>
                <h1 class="hover:text-xl hover:font-semibold">About Us</h1>
                <h1 class="hover:text-xl hover:font-semibold">Contact</h1>
            </div>
