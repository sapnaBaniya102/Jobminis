...
<body class=" overflow-x-hidden lg:overflow-x-auto lg:overflow-hidden flex items-center justify-center lg:h-screen">
   ...
   <br /><a href='javascript:history.go(-1)'>Go Back</a>";
            ...
            $output .= '<p>-------------------------------------------------------------</p>';
            $output .= '<p><a href="http://localhost:3000/Jobminis/views/auth/password-reset.php?
key=' . $key . '&email=' . $email . '" target="_blank">reset-password.php
...
your account and change your security password as someone may have guessed it.</p>';
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'a95096e9404e8b';
            $mail->Password = '56c5f07bce97c6';
