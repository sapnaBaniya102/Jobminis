        ...
        <div class="footer-container grid grid-cols-3 py-9 ">
            <div class="website-detail ml-20">
                <div class="logo w-72 -mt-7">
                    <img src="../../../assets/img/Jobminis-removebg-preview.png" alt="">
                </div>
            ...
            <div class="navbar-links text-center text-white space-y-1">
                ...
                <h1 class="text-base hover:text-xl hover:font-semibold" ><a href="../app/dashboard.php">Home</a> </h1>
                <!-- <h1 class="hover:text-xl hover:font-semibold">Blog</h1> -->
                <h1 class="hover:text-xl hover:font-semibold"><a href="../app/companyList.php">Company</a> </h1>
                <h1 class="hover:text-xl hover:font-semibold"><a href="../app/candidateList.php">Candidate</a> </h1>
                <h1 class="hover:text-xl hover:font-semibold"><a href="../app/dashboard.php">Contact</a> </h1>
            </div>
