  ...
  <div class=" flex flex-row flex-wrap">
   ...
   <section class="content w-full ">
      <div class="container-fluid md:w-5/6 mx-auto ">
        ...
        <a href="adduser.php" class="relative left-8 top-14"> <button class="btn  btn-primary p-2">Add</button></a> 
                  ...
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="py-2 px-4 ">
                      <div class="flex justify-between space-x-2">
                        <a name="" id="" class="w-1 btn btn-danger" href="../process/deleteuser.php?id=<?php echo $data['id']; ?>" role="button"><i class="fa-solid fa-trash-can -ml-2"></i></a>
                        <a name="" id="" class="w-1 btn btn-primary" href="../process/edituser.php?id=<?php echo $data['id']; ?>" role="button" target="_blank"><i class="fa-solid fa-pen -ml-2"></i></a></td>
