    ...
    <div class=" flex flex-row flex-wrap">
      ...
      <section class="content w-full ">
        <div class="container-fluid w-4/5 mx-auto">
          ...
          <a href="managesiteconfig.php" class="relative  mx-auto top-16 left-6"> <button class="btn btn-primary p-2">Manage</button></a>

          <!-- left column -->
          <div class="col-md-12">
            <div class="card  rounded-xl">
              <div class="card-header bg-gray-800 rounded-t-xl">
                <h3 class="card-title text-white text-center font-semibold text-lg">Add New Site config</h3>
              ...
              <div class="card-body overflow-x-auto relative">
                <form action="" method="post" enctype="multipart/form-data" class="md:w-4/5 w-3/4 mx-auto">
                  <div id="error" class="bg-red-100 mb-2 hidden border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                    ...
                    <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                      <svg class="fill-current h-6 w-6 text-red-500" role="button" id="close" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <title>Close</title>
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                      ...
                      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="key" name="key" type="text" placeholder="Key">
                    </div>
                  </div>
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="value" name="value" type="text" placeholder="Value">
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="value" name="status" type="text" placeholder="Status">
                      <!-- <p class="text-gray-600 text-xs italic">Make it as long and as crazy as you'd like</p> -->
                    </div>
                  </div>
                ...
                <div id="toast-success" class="flex hidden fixed z-50 right-10 bottom-32 items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                  ...
                  <div class="ml-3 text-sm font-normal">Site config added successfully.</div>
                ...
                <div id="toast-warning" class="flex hidden fixed z-50 right-10 bottom-32 items-center p-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                  ...
                  <div class="ml-3 text-sm font-normal">Error while adding site config</div>
...
if (isset($_POST['submit'])) {
  ...
  if ($name == '' || $key == '' || $value == '') {
    ...
    $query = "INSERT INTO siteconfig (name, site_key, site_value, status,  user_id) VALUES('$name','$key','$value', 'Active','$id') ";
