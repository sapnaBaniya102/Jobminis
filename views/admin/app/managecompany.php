                  ...
                  <tbody>
                    ...
                    ?>
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="py-2 px-4">
                          <p class="truncate w-36"><?php echo $data['information']; ?></p>
                        </td>
                        ...
                        <td class="py-2 px-4 ">
                          <td class="flex justify-between space-x-2">
                            ...
                            <a name="" id="" class="w-1 btn btn-primary" href="../process/editcompany.php?id=<?php echo $data['id']; ?>" role="button" target="_blank"><i class="fa-solid fa-pen -ml-2"></i></a>
                        </td>
