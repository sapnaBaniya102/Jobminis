    ...
    <div class=" flex flex-row flex-wrap">
      ...
      <section class="content w-full ">
        <div class="container-fluid md:w-5/6 mx-auto ">
          ...
          <a href="addfile.php" class="relative left-8 top-14"> <button class="btn  btn-primary p-2">Add</button></a>
          <!-- left column -->
          <div class="col-md-12">
            <div class="card rounded-xl">
              <div class="card-header bg-gray-800 rounded-t-xl">
                <h3 class="card-title text-center font-semibold text-lg text-white">Manage Files</h3>
                      ...
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" id="<?php echo $data['id'] ;?>">
                        ...
                        <td class="py-2">
                          <div class="flex justify-between space-x-2">
                            ...
                            <a name="" id="" class="w-1 btn bg-yellow-200 hover:bg-yellow-300" href="../../user/uploads/<?php echo $data['filelink']; ?>" role="button" target="_blank"><i class="fa-solid fa-eye -ml-2 text-yellow-500"></i></a>
                        </td>
