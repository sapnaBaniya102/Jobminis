...
if (isset($_GET['id'])) {
    # code...
    $companyId = $_GET['id'];
    $query = "SELECT * FROM user_details WHERE id = '$companyId'";
    $result = mysqli_query($conn, $query);
    while ($row = mysqli_fetch_assoc($result)) {
        # code...
$name = $row['name'];
$information = $row['information'];
$founded = $row['founded_at'];
$email = $row['email'];
$user = $row['user_id'];
 ...
 require('../inc/sidebar.php');
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <input value="<?php echo $name; ?>" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="name" name="name" readonly type="text" placeholder="Jane">
    ...
    <div class="w-full md:w-1/2 px-3">
      ...
      <input value="<?php echo $information; ?>" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="information" name="information" readonly type="text" placeholder="Information">
    </div>
  </div>
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-1/2 px-3">
      ...
      <input value="<?php echo $founded; ?>" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="founded" name="founded" readonly type="text" placeholder="founded">
...
Email
      ...
      <input value="<?php echo $email; ?>" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="email" name="email" readonly type="text" placeholder="email">
      <!-- <p class="text-gray-600 text-xs italic">Make it as long and as crazy as you'd like</p> -->
    </div>
  </div>
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-1/3 px-3">
      ...
      <input value="<?php echo $user; ?>" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="user" name="user" readonly type="text" placeholder="user">
      <!-- <p class="text-gray-600 text-xs italic">Make it as long and as crazy as you'd like</p> -->
    </div>
    <div class="w-1/3 px-3">
...
Total Job
      ...
      <input value="<?php echo $totalJob; ?>" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="job" name="job" readonly type="text" placeholder="job">
      <!-- <p class="text-gray-600 text-xs italic">Make it as long and as crazy as you'd like</p> -->
    </div>
    <div class="w-1/3 px-3">
