    ...
    <div class=" flex flex-row flex-wrap">
      ...
      <section class="content w-full ">
        <div class="container-fluid w-4/5 mx-auto">
          ...
          <a href="../app/managesiteconfig.php" class="relative  mx-auto top-16 left-6"> <button class="btn btn-primary p-2">Manage</button></a>

          <!-- left column -->
          <div class="col-md-12">
            <div class="card  rounded-xl">
              <div class="card-header bg-gray-800 rounded-t-xl">
                <h3 class="card-title text-white text-center font-semibold text-lg">Edit Siteconfig</h3>
              ...
              <div class="card-body overflow-x-auto relative">
                ...
                <form action="#" method="POST" enctype="multipart/form-data" class="md:w-4/5 w-3/4 mx-auto">
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                      ...
                      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="name" name="name" type="text" value="<?php echo $name; ?>" placeholder="Jane">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                      ...
                      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="key" name="key" type="text" value="<?php echo $site_key; ?>" placeholder="Key">
                    </div>
                  </div>
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="value" name="value" type="text" value="<?php echo $site_value; ?>" placeholder="Value">
                ...
                <div id="toast-success" class="flex hidden fixed z-50 right-10 bottom-32 items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                  ...
                  <div class="ml-3 text-sm font-normal">Site config edited successfully.</div>
